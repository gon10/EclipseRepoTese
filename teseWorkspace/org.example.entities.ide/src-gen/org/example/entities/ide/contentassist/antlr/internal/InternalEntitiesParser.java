...
public class InternalEntitiesParser extends AbstractInternalContentAssistParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_INT", "RULE_STRING", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'string'", "'integer'", "'boolean'", "'entity'", "'{'", "'}'", "'extends'", "';'", "']'", "'['"
    };
    ...
    // InternalEntities.g:248:1: rule__BasicType__TypeNameAlternatives_0 : ( ( 'string' ) | ( 'integer' ) | ( 'boolean' ) );
    public final void rule__BasicType__TypeNameAlternatives_0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalEntities.g:252:1: ( ( 'string' ) | ( 'integer' ) | ( 'boolean' ) )
            int alt3=3;
            switch ( input.LA(1) ) {
            case 11:
                {
            ...
            switch (alt3) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalEntities.g:259:2: ( 'integer' )
                    {
                    // InternalEntities.g:259:2: ( 'integer' )
                    // InternalEntities.g:260:3: 'integer'
                    {
                     before(grammarAccess.getBasicTypeAccess().getTypeNameIntegerKeyword_0_1()); 
                    match(input,12,FOLLOW_2); 
                     after(grammarAccess.getBasicTypeAccess().getTypeNameIntegerKeyword_0_1()); 
