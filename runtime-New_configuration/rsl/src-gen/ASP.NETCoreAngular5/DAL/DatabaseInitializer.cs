    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        public async Task SeedAsync()
        {
            ...
            if (!await _context.Users.AnyAsync())
            {
				...
				//________feito por mim
				await CreateUserAsync("AU_Manager", "tempP@ss123", "Inbuilt AU_Manager", "AU_Manager@ebenmonney.com", "012345", new string[] { AU_ManagerRoleName });
				await CreateUserAsync("AU_Operator", "tempP@ss123", "Inbuilt AU_Operator", "AU_Operator@ebenmonney.com", "012345", new string[] { AU_OperatorRoleName });
				await CreateUserAsync("AU_Operator_Customers", "tempP@ss123", "Inbuilt AU_Operator_Customers", "AU_Operator_Customers@ebenmonney.com", "012345", new string[] { AU_Operator_CustomersRoleName });
				//________
