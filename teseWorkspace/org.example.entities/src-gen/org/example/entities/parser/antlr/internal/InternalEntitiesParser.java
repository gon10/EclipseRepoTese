...
public class InternalEntitiesParser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_INT", "RULE_STRING", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'entity'", "'extends'", "'{'", "'}'", "';'", "'['", "']'", "'string'", "'integer'", "'boolean'"
    };
    ...
    // InternalEntities.g:366:1: ruleBasicType returns [EObject current=null] : ( ( (lv_typeName_0_1= 'string' | lv_typeName_0_2= 'integer' | lv_typeName_0_3= 'boolean' ) ) ) ;
    public final EObject ruleBasicType() throws RecognitionException {
        ...
        try {
            // InternalEntities.g:372:2: ( ( ( (lv_typeName_0_1= 'string' | lv_typeName_0_2= 'integer' | lv_typeName_0_3= 'boolean' ) ) ) )
            // InternalEntities.g:373:2: ( ( (lv_typeName_0_1= 'string' | lv_typeName_0_2= 'integer' | lv_typeName_0_3= 'boolean' ) ) )
            {
            // InternalEntities.g:373:2: ( ( (lv_typeName_0_1= 'string' | lv_typeName_0_2= 'integer' | lv_typeName_0_3= 'boolean' ) ) )
            // InternalEntities.g:374:3: ( (lv_typeName_0_1= 'string' | lv_typeName_0_2= 'integer' | lv_typeName_0_3= 'boolean' ) )
            {
            // InternalEntities.g:374:3: ( (lv_typeName_0_1= 'string' | lv_typeName_0_2= 'integer' | lv_typeName_0_3= 'boolean' ) )
            // InternalEntities.g:375:4: (lv_typeName_0_1= 'string' | lv_typeName_0_2= 'integer' | lv_typeName_0_3= 'boolean' )
            {
            // InternalEntities.g:375:4: (lv_typeName_0_1= 'string' | lv_typeName_0_2= 'integer' | lv_typeName_0_3= 'boolean' )
            int alt7=3;
            switch ( input.LA(1) ) {
            ...
            switch (alt7) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalEntities.g:387:5: lv_typeName_0_2= 'integer'
                    {
                    lv_typeName_0_2=(Token)match(input,19,FOLLOW_2); 

                    					newLeafNode(lv_typeName_0_2, grammarAccess.getBasicTypeAccess().getTypeNameIntegerKeyword_0_1());
