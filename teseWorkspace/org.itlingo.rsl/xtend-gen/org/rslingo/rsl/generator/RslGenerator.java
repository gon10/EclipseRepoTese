...
public class RslGenerator extends AbstractGenerator {
  ...
  public void doGenerate(final Resource resource, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    ...
    for (final DataEntity e_2 : _filter_2) {
      ...
      String _plus_2 = ("ASP.NETCoreAngular5/DAL/Models/" + _name_1);
    ...
    for (final DataEntity e_3 : _filter_3) {
      ...
      String _plus_4 = ("ASP.NETCoreAngular5/ViewModels/" + _name_2);
    ...
    fsa.generateFile(
      "ASP.NETCoreAngular5/DAL/Core/ApplicationPermissions.cs", _compileApplicationPermissions);
    ...
    fsa.generateFile(
      ("ASP.NETCoreAngular5/DAL/ApplicationDbContext" + ".cs"), _compileAppDb);
    CharSequence _compileDatabaseInitializer = this.compileDatabaseInitializer(this.useCases);
    fsa.generateFile(
      "ASP.NETCoreAngular5/DAL/DatabaseInitializer.cs", _compileDatabaseInitializer);
    CharSequence _compileSettingsComponentHTML = this.compileSettingsComponentHTML(this.entities);
    fsa.generateFile(
      "ASP.NETCoreAngular5/QuickApp/ClientApp/src/app/components/settings/settings.component.html", _compileSettingsComponentHTML);
    CharSequence _compileSettingsComponenTS = this.compileSettingsComponenTS(this.entities);
    fsa.generateFile(
      "ASP.NETCoreAngular5/QuickApp/ClientApp/src/app/components/settings/settings.component.ts", _compileSettingsComponenTS);
    ...
    Iterable<DataEntity> _filter_5 = Iterables.<DataEntity>filter(_iterable_5, DataEntity.class);
    for (final DataEntity e_4 : _filter_5) {
      String _name_3 = e_4.getName();
      String _replace = _name_3.replace("_", "-");
      String _lowerCase = _replace.toLowerCase();
      String _plus_6 = ("ASP.NETCoreAngular5/QuickApp/ClientApp/src/app/components/controls/" + _lowerCase);
      String _plus_7 = (_plus_6 + "-management.component.ts");
      CharSequence _compileComponentsControlsTS = this.compileComponentsControlsTS(e_4);
      fsa.generateFile(_plus_7, _compileComponentsControlsTS);
    }
    ...
    Iterable<DataEntity> _filter_6 = Iterables.<DataEntity>filter(_iterable_6, DataEntity.class);
    for (final DataEntity e_5 : _filter_6) {
      String _name_4 = e_5.getName();
      String _replace_1 = _name_4.replace("_", "-");
      String _lowerCase_1 = _replace_1.toLowerCase();
      String _plus_8 = ("ASP.NETCoreAngular5/QuickApp/ClientApp/src/app/components/controls/" + _lowerCase_1);
      String _plus_9 = (_plus_8 + "-management.component.html");
      CharSequence _compileComponentsControlsHTML = this.compileComponentsControlsHTML(e_5);
      fsa.generateFile(_plus_9, _compileComponentsControlsHTML);
    }
    ...
    Iterable<DataEntity> _filter_7 = Iterables.<DataEntity>filter(_iterable_7, DataEntity.class);
    for (final DataEntity e_6 : _filter_7) {
      String _name_5 = e_6.getName();
      String _replace_2 = _name_5.replace("_", "-");
      String _lowerCase_2 = _replace_2.toLowerCase();
      String _plus_10 = ("ASP.NETCoreAngular5/QuickApp/ClientApp/src/app/components/controls/" + _lowerCase_2);
      String _plus_11 = (_plus_10 + "-management.component.css");
      CharSequence _compileComponentsControlsCSS = this.compileComponentsControlsCSS(e_6);
      fsa.generateFile(_plus_11, _compileComponentsControlsCSS);
    }
    CharSequence _compileAppModule = this.compileAppModule(this.entities);
    fsa.generateFile(
      "ASP.NETCoreAngular5/QuickApp/ClientApp/src/app/app.module.ts", _compileAppModule);
  ...
  public CharSequence compileAppModule(final ArrayList<DataEntity> entities) {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("import { NgModule, ErrorHandler } from \"@angular/core\";");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("import { BrowserAnimationsModule } from \'@angular/platform-browser/animations\';");
    _builder.newLine();
    _builder.append("import { HttpClientModule } from \'@angular/common/http\';");
    _builder.newLine();
    _builder.newLine();
    _builder.append("import { TranslateModule, TranslateLoader } from \"@ngx-translate/core\";");
    _builder.newLine();
    _builder.append("import { NgxDatatableModule } from \'@swimlane/ngx-datatable\';");
    _builder.newLine();
    _builder.append("import { ToastaModule } from \'ngx-toasta\';");
    _builder.newLine();
    _builder.append("import { ModalModule } from \'ngx-bootstrap/modal\';");
    _builder.newLine();
    _builder.append("import { TooltipModule } from \"ngx-bootstrap/tooltip\";");
    _builder.newLine();
    _builder.append("import { PopoverModule } from \"ngx-bootstrap/popover\";");
    _builder.newLine();
    _builder.append("import { BsDropdownModule } from \'ngx-bootstrap/dropdown\';");
    _builder.newLine();
    _builder.append("import { CarouselModule } from \'ngx-bootstrap/carousel\';");
    _builder.newLine();
    _builder.append("import { ChartsModule } from \'ng2-charts\';");
    _builder.newLine();
    _builder.newLine();
    _builder.append("import { AppRoutingModule } from \'./app-routing.module\';");
    _builder.newLine();
    _builder.append("import { AppErrorHandler } from \'./app-error.handler\';");
    _builder.newLine();
    _builder.append("import { AppTitleService } from \'./services/app-title.service\';");
    _builder.newLine();
    _builder.append("import { AppTranslationService, TranslateLanguageLoader } from \'./services/app-translation.service\';");
    _builder.newLine();
    _builder.append("import { ConfigurationService } from \'./services/configuration.service\';");
    _builder.newLine();
    _builder.append("import { AlertService } from \'./services/alert.service\';");
    _builder.newLine();
    _builder.append("import { LocalStoreManager } from \'./services/local-store-manager.service\';");
    _builder.newLine();
    _builder.append("import { EndpointFactory } from \'./services/endpoint-factory.service\';");
    _builder.newLine();
    _builder.append("import { NotificationService } from \'./services/notification.service\';");
    _builder.newLine();
    _builder.append("import { NotificationEndpoint } from \'./services/notification-endpoint.service\';");
    _builder.newLine();
    _builder.append("import { AccountService } from \'./services/account.service\';");
    _builder.newLine();
    _builder.append("import { AccountEndpoint } from \'./services/account-endpoint.service\';");
    _builder.newLine();
    _builder.newLine();
    _builder.append("import { EqualValidator } from \'./directives/equal-validator.directive\';");
    _builder.newLine();
    _builder.append("import { LastElementDirective } from \'./directives/last-element.directive\';");
    _builder.newLine();
    _builder.append("import { AutofocusDirective } from \'./directives/autofocus.directive\';");
    _builder.newLine();
    _builder.append("import { BootstrapTabDirective } from \'./directives/bootstrap-tab.directive\';");
    _builder.newLine();
    _builder.append("import { BootstrapToggleDirective } from \'./directives/bootstrap-toggle.directive\';");
    _builder.newLine();
    _builder.append("import { BootstrapSelectDirective } from \'./directives/bootstrap-select.directive\';");
    _builder.newLine();
    _builder.append("import { BootstrapDatepickerDirective } from \'./directives/bootstrap-datepicker.directive\';");
    _builder.newLine();
    _builder.append("import { GroupByPipe } from \'./pipes/group-by.pipe\';");
    _builder.newLine();
    _builder.newLine();
    _builder.append("import { AppComponent } from \"./components/app.component\";");
    _builder.newLine();
    _builder.append("import { LoginComponent } from \"./components/login/login.component\";");
    _builder.newLine();
    _builder.append("import { HomeComponent } from \"./components/home/home.component\";");
    _builder.newLine();
    _builder.append("import { CustomersComponent } from \"./components/customers/customers.component\";");
    _builder.newLine();
    _builder.append("import { ProductsComponent } from \"./components/products/products.component\";");
    _builder.newLine();
    _builder.append("import { OrdersComponent } from \"./components/orders/orders.component\";");
    _builder.newLine();
    _builder.append("import { SettingsComponent } from \"./components/settings/settings.component\";");
    _builder.newLine();
    _builder.append("import { AboutComponent } from \"./components/about/about.component\";");
    _builder.newLine();
    _builder.append("import { NotFoundComponent } from \"./components/not-found/not-found.component\";");
    _builder.newLine();
    _builder.newLine();
    _builder.append("import { BannerDemoComponent } from \"./components/controls/banner-demo.component\";");
    _builder.newLine();
    _builder.append("import { TodoDemoComponent } from \"./components/controls/todo-demo.component\";");
    _builder.newLine();
    _builder.append("import { StatisticsDemoComponent } from \"./components/controls/statistics-demo.component\";");
    _builder.newLine();
    _builder.append("import { NotificationsViewerComponent } from \"./components/controls/notifications-viewer.component\";");
    _builder.newLine();
    _builder.append("import { SearchBoxComponent } from \"./components/controls/search-box.component\";");
    _builder.newLine();
    _builder.append("import { UserInfoComponent } from \"./components/controls/user-info.component\";");
    _builder.newLine();
    _builder.append("import { UserPreferencesComponent } from \"./components/controls/user-preferences.component\";");
    _builder.newLine();
    _builder.append("import { UsersManagementComponent } from \"./components/controls/users-management.component\";");
    _builder.newLine();
    _builder.append("import { RolesManagementComponent } from \"./components/controls/roles-management.component\";");
    _builder.newLine();
    _builder.append("import { RoleEditorComponent } from \"./components/controls/role-editor.component\";");
    _builder.newLine();
    _builder.newLine();
    ...
    _builder.newLine();
    {
      for(final DataEntity entity : entities) {
        ...
        _builder.append("ManagementComponent } from \"./components/controls/");
        String _name_1 = entity.getName();
        String _replace_1 = _name_1.replace("_", "-");
        String _lowerCase = _replace_1.toLowerCase();
        _builder.append(_lowerCase, "");
        _builder.append("-management.component\";");
      }
    }
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("BrowserAnimationsModule,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("HttpClientModule,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("FormsModule,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("AppRoutingModule,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("TranslateModule.forRoot({");
    _builder.newLine();
    _builder.append("      ");
    _builder.append("loader: {");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("provide: TranslateLoader,");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("useClass: TranslateLanguageLoader");
    _builder.newLine();
    _builder.append("      ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("NgxDatatableModule,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("ToastaModule.forRoot(),");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("TooltipModule.forRoot(),");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("PopoverModule.forRoot(),");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("BsDropdownModule.forRoot(),");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("CarouselModule.forRoot(),");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("ModalModule.forRoot(),");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("ChartsModule");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("],");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("AppComponent,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("LoginComponent,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("HomeComponent,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("CustomersComponent,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("ProductsComponent,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("OrdersComponent,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("SettingsComponent,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("UsersManagementComponent, UserInfoComponent, UserPreferencesComponent, ");
    {
      for(final DataEntity entity_1 : entities) {
        String _name_2 = entity_1.getName();
        String _replace_2 = _name_2.replace("_", "");
        _builder.append(_replace_2, "    ");
        _builder.append("ManagementComponent,");
      }
    }
    _builder.newLineIfNotEmpty();
    _builder.append("    ");
    _builder.append("RolesManagementComponent, RoleEditorComponent,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("AboutComponent,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("NotFoundComponent,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("NotificationsViewerComponent,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("SearchBoxComponent,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("StatisticsDemoComponent, TodoDemoComponent, BannerDemoComponent,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("EqualValidator,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("LastElementDirective,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("AutofocusDirective,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("BootstrapTabDirective,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("BootstrapToggleDirective,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("BootstrapSelectDirective,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("BootstrapDatepickerDirective,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("GroupByPipe");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("],");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("{ provide: \'BASE_URL\', useFactory: getBaseUrl },");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("{ provide: ErrorHandler, useClass: AppErrorHandler },");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("AlertService,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("ConfigurationService,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("AppTitleService,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("AppTranslationService,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("NotificationService,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("NotificationEndpoint,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("AccountService,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("AccountEndpoint,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("LocalStoreManager,");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("EndpointFactory");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("],");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("bootstrap: [AppComponent]");
    _builder.newLine();
    _builder.append("})");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("export function getBaseUrl() {");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("return document.getElementsByTagName(\'base\')[0].href;");
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
    _builder.newLine();
  ...
  public CharSequence compileComponentsControlsCSS(final DataEntity entity) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append(".user-role {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("font-size: 0.8em !important;");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("margin-right: 1px;");
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
    _builder.newLine();
    _builder.append(".control-box {");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append(".action-box {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("margin: 0 50px 0 0;");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("min-height: 0;");
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append(".action-box .toolbaritem a {");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("padding-top: 5px;");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("padding-bottom: 5px;");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("min-width: 100px;");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
    _builder.newLine();
    _builder.newLine();
    _builder.append(".user-disabled {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("color: #777;");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append(".locked-out {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("background-color: orangered;");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("color: whitesmoke;");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("@media (max-width: 768px) {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append(".action-box {");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("margin: 0 14px;");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
  ...
  public CharSequence compileComponentsControlsHTML(final DataEntity entity) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("<div>");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("<div class=\"row control-box\">");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("<div class=\"col-sm-8\">");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("<div class=\"form-group search-box\">");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("<search-box (searchChange)=\"onSearchChanged($event)\" placeholder=\"");
    String _name = entity.getName();
    ...
    _builder.newLine();
    _builder.append("            ");
    _builder.append("<div class=\"navbar action-box\">");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("<ul class=\"nav navbar-nav navbar-right\">");
    _builder.newLine();
    _builder.append("                    ");
    _builder.append("<li *ngIf=\"canManageUsers && canAssignRoles\" class=\"toolbaritem\">");
    _builder.newLine();
    _builder.append("                        ");
    _builder.append("<a href=\"javascript:;\" (click)=\"newUser(row)\">");
    _builder.newLine();
    _builder.append("                            ");
    _builder.append("<i class=\"fa fa-plus-circle\"></i> New ");
    String _name_1 = entity.getName();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("<ngx-datatable class=\"material colored-header sm table table-striped table-hover\"");
    _builder.newLine();
    _builder.append("                   ");
    _builder.append("[loadingIndicator]=\"loadingIndicator\"");
    _builder.newLine();
    _builder.append("                   ");
    _builder.append("[rows]=\"rows\"");
    _builder.newLine();
    _builder.append("                   ");
    _builder.append("[rowHeight]=\"35\"");
    _builder.newLine();
    _builder.append("                   ");
    _builder.append("[headerHeight]=\"35\"");
    _builder.newLine();
    _builder.append("                   ");
    _builder.append("[footerHeight]=\"35\"");
    _builder.newLine();
    _builder.append("                   ");
    _builder.append("[columns]=\"columns\"");
    _builder.newLine();
    _builder.append("                   ");
    _builder.append("[scrollbarV]=\"true\"");
    _builder.newLine();
    _builder.append("                   ");
    _builder.append("[columnMode]=\"\'force\'\">");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("</ngx-datatable>");
    _builder.newLine();
    _builder.newLine();
    _builder.append("</div>");
    _builder.newLine();
  ...
  public CharSequence compileComponentsControlsTS(final DataEntity entity) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("// ====================================================");
    _builder.newLine();
    _builder.append("// More Templates: https://www.ebenmonney.com/templates");
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("import { Component, OnInit, AfterViewInit, TemplateRef, ViewChild, Input } from \'@angular/core\';");
    _builder.newLine();
    _builder.append("import { ModalDirective } from \'ngx-bootstrap/modal\';");
    _builder.newLine();
    _builder.newLine();
    _builder.append("import { AlertService, DialogType, MessageSeverity } from \'../../services/alert.service\';");
    _builder.newLine();
    _builder.append("import { AppTranslationService } from \"../../services/app-translation.service\";");
    _builder.newLine();
    _builder.append("import { AccountService } from \"../../services/account.service\";");
    _builder.newLine();
    _builder.append("import { Utilities } from \"../../services/utilities\";");
    _builder.newLine();
    _builder.append("import { User } from \'../../models/user.model\';");
    _builder.newLine();
    _builder.append("import { Role } from \'../../models/role.model\';");
    _builder.newLine();
    _builder.append("import { Permission } from \'../../models/permission.model\';");
    _builder.newLine();
    _builder.append("import { UserEdit } from \'../../models/user-edit.model\';");
    _builder.newLine();
    _builder.append("import { UserInfoComponent } from \"./user-info.component\";");
    _builder.newLine();
    _builder.newLine();
    _builder.newLine();
    ...
    _builder.append("-management.component.html\',");
    _builder.newLineIfNotEmpty();
    _builder.append("    ");
    ...
    _builder.append("-management.component.css\']");
    _builder.newLineIfNotEmpty();
    _builder.append("})");
    _builder.newLine();
    _builder.append("export class ");
    String _name_3 = entity.getName();
    String _replace_3 = _name_3.replace("_", "");
    _builder.append(_replace_3, "");
    _builder.append("ManagementComponent implements OnInit{");
    _builder.newLineIfNotEmpty();
    _builder.append("    ");
    _builder.append("columns: any[] = [];");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("rows: any[] = [];");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("loadingIndicator: boolean;");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("constructor(private alertService: AlertService, private translationService: AppTranslationService, private accountService: AccountService) {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("ngOnInit() {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("        ");
    _builder.append("let gT = (key: string) => this.translationService.getTranslation(key);");
    _builder.newLine();
    _builder.newLine();
    _builder.append("        ");
    _builder.append("this.columns = [");
    _builder.newLine();
    {
      EList<Attribute> _attributes = entity.getAttributes();
      for(final Attribute atributo : _attributes) {
        {
          if ((Objects.equal(atributo, IterableExtensions.<Attribute>last(entity.getAttributes())) && Objects.equal(entity.getDescription(), null))) {
            _builder.append("        \t");
            _builder.append("{ prop: \'");
            String _name_4 = atributo.getName();
            _builder.append(_name_4, "        \t");
            _builder.append("\', name: \'");
            String _name_5 = atributo.getName();
            ...
            _builder.append("        \t");
            _builder.append("{ prop: \"");
            String _name_6 = atributo.getName();
            _builder.append(_name_6, "        \t");
            _builder.append("\", name: \'");
            String _name_7 = atributo.getName();
    ...
    }
    {
      ...
      if (_notEquals) {
        _builder.append("        \t");
        _builder.append("{ prop: \'Description\', name: \'Description\'}");
        _builder.newLine();
      }
    }
    _builder.append("      ");
  ...
  public CharSequence compileSettingsComponenTS(final ArrayList<DataEntity> entities) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("// ====================================================");
    _builder.newLine();
    _builder.append("// More Templates: https://www.ebenmonney.com/templates");
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("import { Component, OnInit, OnDestroy, ViewChild } from \'@angular/core\';");
    _builder.newLine();
    _builder.append("import { ActivatedRoute } from \'@angular/router\';");
    _builder.newLine();
    _builder.newLine();
    _builder.newLine();
    _builder.append("import { fadeInOut } from \'../../services/animations\';");
    _builder.newLine();
    _builder.append("import { BootstrapTabDirective } from \"../../directives/bootstrap-tab.directive\";");
    _builder.newLine();
    _builder.append("import { AccountService } from \"../../services/account.service\";");
    ...
    _builder.newLine();
    _builder.append("  ");
    _builder.append("selector: \'settings\',");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("templateUrl: \'./settings.component.html\',");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("styleUrls: [\'./settings.component.css\'],");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("animations: [fadeInOut]");
    _builder.newLine();
    _builder.append("})");
    _builder.newLine();
    _builder.append("export class SettingsComponent implements OnInit, OnDestroy {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("  ");
    _builder.append("isProfileActivated = true;");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("isPreferencesActivated = false;");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("isUsersActivated = false;");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("isRolesActivated = false;");
    _builder.newLine();
    {
      for(final DataEntity entity : entities) {
        _builder.append("  ");
        ...
        String _name = entity.getName();
        _builder.append(_name, "  ");
        _builder.append("Activated = false;");
        _builder.newLineIfNotEmpty();
      }
    }
    _builder.newLine();
    _builder.append("  ");
    _builder.append("fragmentSubscription: any;");
    _builder.newLine();
    _builder.newLine();
    _builder.append("  ");
    _builder.append("readonly profileTab = \"profile\";");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("readonly preferencesTab = \"preferences\";");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("readonly usersTab = \"users\";");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("readonly rolesTab = \"roles\";");
    _builder.newLine();
    {
      for(final DataEntity entity_1 : entities) {
        _builder.append("  ");
    ...
    _builder.newLine();
    _builder.append("  ");
    _builder.append("@ViewChild(\"tab\")");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("tab: BootstrapTabDirective;");
    _builder.newLine();
    _builder.newLine();
    _builder.newLine();
    _builder.append("  ");
    _builder.append("constructor(private route: ActivatedRoute, private accountService: AccountService) {");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("this.fragmentSubscription = this.route.fragment.subscribe(anchor => this.showContent(anchor));");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("  ");
    _builder.append("ngOnDestroy() {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("this.fragmentSubscription.unsubscribe();");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("}");
    _builder.newLine();
    _builder.newLine();
    _builder.append("  ");
    _builder.append("showContent(anchor: string) {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("if ((this.isFragmentEquals(anchor, this.usersTab) && !this.canViewUsers) ||");
    _builder.newLine();
    _builder.append("      ");
    _builder.append("(this.isFragmentEquals(anchor, this.rolesTab) && !this.canViewRoles)");
    _builder.newLine();
    {
      for(final DataEntity entity_2 : entities) {
        _builder.append("      ");
        _builder.append("|| (this.isFragmentEquals(anchor, this.");
        String _name_3 = entity_2.getName();
        _builder.append(_name_3, "      ");
        _builder.append("Tab) && !this.canView");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("this.tab.show(`#${anchor || this.profileTab}Tab`);");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("  ");
    _builder.append("isFragmentEquals(fragment1: string, fragment2: string) {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("if (fragment1 == null)");
    _builder.newLine();
    _builder.append("      ");
    _builder.append("fragment1 = \"\";");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("if (fragment2 == null)");
    _builder.newLine();
    _builder.append("      ");
    _builder.append("fragment2 = \"\";");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("return fragment1.toLowerCase() == fragment2.toLowerCase();");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("  ");
    _builder.append("onShowTab(event) {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("let activeTab = event.target.hash.split(\"#\", 2).pop();");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("this.isProfileActivated = activeTab == this.profileTab;");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("this.isPreferencesActivated = activeTab == this.preferencesTab;");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("this.isUsersActivated = activeTab == this.usersTab;");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("this.isRolesActivated = activeTab == this.rolesTab;");
    _builder.newLine();
    {
      for(final DataEntity entity_3 : entities) {
        _builder.append("\t");
        _builder.append("this.is");
        String _name_5 = entity_3.getName();
        _builder.append(_name_5, "\t");
        _builder.append("Activated = activeTab == this.");
        String _name_6 = entity_3.getName();
        _builder.append(_name_6, "\t");
        _builder.append("Tab;");
        _builder.newLineIfNotEmpty();
      }
    ...
    _builder.newLine();
    _builder.append("  ");
    _builder.append("get canViewUsers() {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("return this.accountService.userHasPermission(Permission.viewUsersPermission);");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("}");
    _builder.newLine();
    _builder.newLine();
    _builder.append("  ");
    _builder.append("get canViewRoles() {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("return this.accountService.userHasPermission(Permission.viewRolesPermission);");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("}");
    _builder.newLine();
    {
      for(final DataEntity entity_4 : entities) {
        _builder.append("  ");
        _builder.append("get canView");
        String _name_7 = entity_4.getName();
        _builder.append(_name_7, "  ");
        _builder.append("() {");
        _builder.newLineIfNotEmpty();
        _builder.append("  ");
  ...
  public CharSequence compileSettingsComponentHTML(final ArrayList<DataEntity> entities) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("<div class=\"container\">");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("<header class=\"pageHeader\">");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("<h3><i class=\"fa fa-cog fa-lg page-caption\" aria-hidden=\"true\"></i> {{\'pageHeader.Settings\' | translate}}</h3>");
    _builder.newLine();
    _builder.append("  ");
    ...
    _builder.newLine();
    _builder.append("  ");
    _builder.append("<div [@fadeInOut] class=\"row\">");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("<div class=\"col-sm-2 side-menu\">");
    _builder.newLine();
    _builder.append("      ");
    _builder.append("<ul bootstrapTab #tab=\"bootstrap-tab\" class=\"nav nav-tabs tabs-left\" (showBSTab)=\"onShowTab($event)\">");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("<li class=\"active\">");
    _builder.newLine();
    _builder.append("          ");
    _builder.append("<a id=\"profileTab\" [routerLink]=\"[]\" fragment=\"profile\" href=\"#profile\" data-toggle=\"tab\"><i class=\"fa fa-user-circle-o fa-fw\" aria-hidden=\"true\"></i> {{\'settings.tab.Profile\' | translate}}</a>");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("</li>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("          ");
    _builder.append("<a id=\"preferencesTab\" [routerLink]=\"[]\" fragment=\"preferences\" href=\"#preferences\" data-toggle=\"tab\"><i class=\"fa fa-sliders fa-fw\" aria-hidden=\"true\"></i> {{\'settings.tab.Preferences\' | translate}}</a>");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("</li>");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("<li [hidden]=\"!canViewUsers\">");
    _builder.newLine();
    _builder.append("          ");
    _builder.append("<a id=\"usersTab\" [routerLink]=\"[]\" fragment=\"users\" href=\"#users\" data-toggle=\"tab\"><i class=\"fa fa-users fa-fw\" aria-hidden=\"true\"></i> {{\'settings.tab.Users\' | translate}}</a>");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("</li>");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("<li [hidden]=\"!canViewRoles\">");
    _builder.newLine();
    _builder.append("          ");
    _builder.append("<a id=\"rolesTab\" [routerLink]=\"[]\" fragment=\"roles\" href=\"#roles\" data-toggle=\"tab\"><i class=\"fa fa-shield fa-fw\" aria-hidden=\"true\"></i> {{\'settings.tab.Roles\' | translate}}</a>");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("</li>");
    _builder.newLine();
    {
      for(final DataEntity entity : entities) {
        _builder.append("        ");
        _builder.append("<li [hidden]=\"!canView");
        String _name = entity.getName();
        _builder.append(_name, "        ");
        _builder.append("\">");
        _builder.newLineIfNotEmpty();
        ...
        String _name_1 = entity.getName();
        _builder.append(_name_1, "          ");
        _builder.append("Tab\" [routerLink]=\"[]\" fragment=\"");
        String _name_2 = entity.getName();
        _builder.append(_name_2, "          ");
        _builder.append("\" href=\"#");
        String _name_3 = entity.getName();
        _builder.append(_name_3, "          ");
        _builder.append("\" data-toggle=\"tab\"><i class=\"fa fa-file-code-o fa-fw\" aria-hidden=\"true\"></i> ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("<div class=\"col-sm-10\">");
    _builder.newLine();
    _builder.append("      ");
    _builder.append("<div class=\"tab-content\">");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("<div class=\"tab-pane active\" id=\"profile\">");
    _builder.newLine();
    _builder.append("          ");
    _builder.append("<h4>{{\'settings.header.UserProfile\' | translate}}</h4>");
    _builder.newLine();
    _builder.append("          ");
    _builder.append("<hr class=\"separator-hr\" />");
    _builder.newLine();
    _builder.append("          ");
    _builder.append("<div [@fadeInOut] *ngIf=\"isProfileActivated\" class=\"content-container\">");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("<user-info></user-info>");
    _builder.newLine();
    _builder.append("          ");
    _builder.append("</div>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("<div class=\"tab-pane\" id=\"preferences\">");
    _builder.newLine();
    _builder.append("          ");
    _builder.append("<h4>{{\'settings.header.UserPreferences\' | translate}}</h4>");
    _builder.newLine();
    _builder.append("          ");
    _builder.append("<hr class=\"separator-hr\" />");
    _builder.newLine();
    _builder.append("          ");
    _builder.append("<div [@fadeInOut] *ngIf=\"isPreferencesActivated\" class=\"content-container\">");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("<user-preferences></user-preferences>");
    _builder.newLine();
    _builder.append("          ");
    _builder.append("</div>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("<div class=\"tab-pane\" id=\"users\">");
    _builder.newLine();
    _builder.append("          ");
    _builder.append("<h4>{{\'settings.header.UsersManagements\' | translate}}</h4>");
    _builder.newLine();
    _builder.append("          ");
    _builder.append("<hr class=\"separator-hr\" />");
    _builder.newLine();
    _builder.append("          ");
    _builder.append("<div [@fadeInOut] *ngIf=\"canViewUsers && isUsersActivated\" class=\"content-container\">");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("<users-management></users-management>");
    _builder.newLine();
    _builder.append("          ");
    _builder.append("</div>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("<div class=\"tab-pane\" id=\"roles\">");
    _builder.newLine();
    _builder.append("          ");
    _builder.append("<h4>{{\'settings.header.RolesManagement\' | translate}}</h4>");
    _builder.newLine();
    _builder.append("          ");
    _builder.append("<hr class=\"separator-hr\" />");
    _builder.newLine();
    _builder.append("          ");
    _builder.append("<div [@fadeInOut] *ngIf=\"canViewRoles && isRolesActivated\" class=\"content-container\">");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("<roles-management></roles-management>");
    _builder.newLine();
    _builder.append("          ");
    _builder.append("</div>");
    _builder.newLine();
    ...
    _builder.newLine();
    {
      for(final DataEntity entity_1 : entities) {
        ...
        _builder.append("        ");
        _builder.append("  ");
        _builder.append("<div [@fadeInOut] *ngIf=\"canView");
        String _name_7 = entity_1.getName();
        _builder.append(_name_7, "          ");
        _builder.append(" && is");
        String _name_8 = entity_1.getName();
        _builder.append(_name_8, "          ");
        _builder.append("Activated\" class=\"content-container\">");
        _builder.newLineIfNotEmpty();
        _builder.append("        ");
        _builder.append("\t");
        _builder.append("<");
        String _name_9 = entity_1.getName();
        String _replace = _name_9.replace("_", "-");
        String _lowerCase = _replace.toLowerCase();
        _builder.append(_lowerCase, "        \t");
        _builder.append("-management></");
        String _name_10 = entity_1.getName();
        String _replace_1 = _name_10.replace("_", "-");
        String _lowerCase_1 = _replace_1.toLowerCase();
        _builder.append(_lowerCase_1, "        \t");
        _builder.append("-management>");
        _builder.newLineIfNotEmpty();
  ...
  public CharSequence compileDatabaseInitializer(final ArrayList<UseCase> cases) {
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    ArrayList<String> actorsForCreateUserAsync = new ArrayList<String>();
    _builder.newLineIfNotEmpty();
    {
      for(final UseCase uc_3 : this.useCases) {
        {
          Actor _actorInitiates_5 = uc_3.getActorInitiates();
          String _name_7 = _actorInitiates_5.getName();
          boolean _contains_3 = actorsForCreateUserAsync.contains(_name_7);
          boolean _not_3 = (!_contains_3);
          if (_not_3) {
            _builder.append("\t\t\t\t");
            _builder.append("await CreateUserAsync(\"");
            Actor _actorInitiates_6 = uc_3.getActorInitiates();
            String _name_8 = _actorInitiates_6.getName();
            _builder.append(_name_8, "\t\t\t\t");
            _builder.append("\", \"tempP@ss123\", \"Inbuilt ");
            Actor _actorInitiates_7 = uc_3.getActorInitiates();
            String _name_9 = _actorInitiates_7.getName();
            _builder.append(_name_9, "\t\t\t\t");
            _builder.append("\", \"");
            Actor _actorInitiates_8 = uc_3.getActorInitiates();
            String _name_10 = _actorInitiates_8.getName();
            _builder.append(_name_10, "\t\t\t\t");
            _builder.append("@ebenmonney.com\", \"012345\", new string[] { ");
            Actor _actorInitiates_9 = uc_3.getActorInitiates();
            String _name_11 = _actorInitiates_9.getName();
            ...
            {
              Actor _actorInitiates_10 = uc_3.getActorInitiates();
              String _name_12 = _actorInitiates_10.getName();
              actorsForCreateUserAsync.add(_name_12);
              _xblockexpression_6 = "";
            }
